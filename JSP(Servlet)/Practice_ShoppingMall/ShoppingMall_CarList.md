-----
### CarList Jsp Page : 선택한 메뉴에 따라 차 종류를 보여주는 페이지
-----
```jsp
...
-----
### RentCarDAO : Category 값에 따라 차 종류를 보여주는 getCategoryCar 구현
-----
```java
package RentCar;
...
```
<div align = "center">
<img src ="https://github.com/sooyounghan/Web/assets/34672301/8bcc9008-babb-4e98-b907-cca672546c05">
</div>
