...
4. 가로 / 세로 행 병합
   - colspan(가로) / rowspan(세로) : 몇 개의 셀을 합칠지 정함
   - <th>나 <td> 태그에서 이루어짐
...
```
6. figcaption 태그 : figure 태그를 감싼 후 figcaption 태그를 이용해 제목이나 설명 글을 입력 (중앙에 정렬되지 않음)
...
<table>
  <caption>
   ...
   <tr>
    <th></th>
    <td colspan = "가로로 합칠 셀의 개수"></td>
    <td></td>
   </tr>

   <tr>
    <td></td>
    <td rowspan = "세로로 합칠 셀의 개수"></td>  
   </tr>
...
7. aria-describedby 속성 : 표에 대한 설명 제공
